...
public class ApplicationSecurityConfiguration extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .disable()
                .authorizeRequests()
//                .antMatchers("/*", "/","/cart", "/cart/*", "/save-application", "/users/register").permitAll()
//                .antMatchers("/jobs/change-rating", "/jobs/add").permitAll()
//                .antMatchers("/applications/add", "/applications/cart").permitAll()
//                .antMatchers("/applications/waiting", "/applications/delivered", "/applications/deliver").permitAll()  .antMatchers("/applications/remove", "/applications/remove-selected", "applications/remove-delivered-flag").hasAuthority("ADMIN")
//                .antMatchers("/logs/all").hasAuthority("MODERATOR")
//                .antMatchers("/jobs/add").hasAuthority("MODERATOR")
